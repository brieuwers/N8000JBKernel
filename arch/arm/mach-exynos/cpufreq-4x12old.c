...
static const unsigned int asv_voltage_s[CPUFREQ_LEVEL_END] = {
	1320000, 1300000, 1300000, 1300000, 1250000, 1200000, 1175000, 1100000,
	1050000, 1025000, 1000000, 1000000, 1000000, 950000, 950000, 900000, 850000, 800000
};

/* ASV table for 12.5mV step */
static const unsigned int asv_voltage_step_12_5[CPUFREQ_LEVEL_END][12] = {
	/*   ASV0,    ASV1,    ASV2,    ASV3,	 ASV4,	  ASV5,	   ASV6,    ASV7,    ASV8,    ASV9,   ASV10,   ASV11 */
	{ 1338000, 1338000, 1338000, 1338000, 1338000, 1338000,	1338000, 1338000, 1338000, 1338000, 1338000, 1338000 },
	{ 1313000, 1313000, 1313000, 1313000, 1313000, 1313000,	1313000, 1313000, 1313000, 1313000, 1313000, 1313000 },	/* L0 - Not used */
	{ 1325000, 1312500, 1300000, 1287500, 1300000, 1287500,	1275000, 1250000, 1250000, 1237500, 1225000, 1212500 },	/* L1 - Not used */
	{ 1264500, 1264500, 1264500, 1264500, 1264500, 1264500,	1264500, 1264500, 1264500, 1264500, 1264500, 1264500 },
	...
	{  875000,  875000,  875000,  875000,  875000,  875000,	 875000,  875000,  875000,  875000,  875000,  875000 },
	{  850000,  837500,  825000,  800000,  825000,  800000,	 800000,  800000,  800000,  887500,  875000,  862500 },
	{  775000,  775000,  775000,  775000,  775000,  775000,	 775000,  775000,  775000,  775000,  775000,  775000 },
	{  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000 },
	{  725000,  725000,  725000,  725000,  725000,  725000,	 725000,  725000,  725000,  725000,  725000,  725000 },
...
int exynos4x12_cpufreq_init(struct exynos_dvfs_info *info)
{
	...
	info->max_current_idx = L0;
	info->min_current_idx = L18;
#ifdef CONFIG_SLP
